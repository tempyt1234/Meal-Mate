  ...
  return (
    ...
    margin:'0.05em'
        ...
        <Carousel controls={false} indicators={false} fade={true} interval={4000} pause={false}>
          <Carousel.Item>
            <img
              ...
              src="https://www.cucinare.tv/wp-content/uploads/2020/12/Familia-comiendo.jpg"
              alt=""
            />
            <Carousel.Caption className="carousel-caption-custom">
              <h3>  <p>Your commitment ensures our customers’ smiles.</p></h3>
          ...
          <Carousel.Item>
            ...
            />
            <Carousel.Caption className="carousel-caption-custom">
              <h3><FaLeaf />Empowering great service through your leadership. </h3>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item>
            <img
              className="d-block w-100 carousel-image"
              src="https://media.istockphoto.com/id/2156866691/photo/the-concept-of-teamwork-and-partnership-businessmans-hands-putting-together-puzzle-pieces-in.jpg?s=612x612&w=0&k=20&c=HDVptF5NSmqAl3bDxDR_NYmkRrqYaI3r4KYqEPopUns="
              alt="Meal Delivery"
            />
            <Carousel.Caption className="carousel-caption-custom">
              <h3><FaShippingFast />Your efforts turn challenges into achievements</h3>
            </Carousel.Caption>
          </Carousel.Item>
        </Carousel>
       
        {/* Description below the carousel */}
        <div className="welcometomealmate" style={{ padding: '2em' ,backgroundColor:'rgb(80,133,165,0.08)',color:'#000'}}>
      ...
      <Container fluid className="home-container">
        <Row className="justify-content-center rowcards">
          <Col xs={12} md={4}>
            <Card className="mb-3">
